...
public class MediaStreamInfoItemExtractor implements StreamInfoItemExtractor {
     ...
     */
    public MediaStreamInfoItemExtractor(final JsonObject videoInfoItem,
    ...
    public String getName() throws ParsingException {
        ...
        // Videos can have no title, e.g. https://www.Media.com/watch?v=nc1kN8ZSfGQ
    ...
    public long getDuration() throws ParsingException {
        ...
        if (isNullOrEmpty(duration)) {
            ...
            if (isNullOrEmpty(duration)) {
                ...
                for (final String timeOverlayText : timeOverlays) {
                    try {
                        return MediaParsingHelper.parseDurationString(timeOverlayText);
        ...
        return MediaParsingHelper.parseDurationString(duration);
    }
    ...
    public boolean isUploaderVerified() throws ParsingException {
        return MediaParsingHelper.isVerified(videoInfo.getArray("ownerBadges"));
    }
