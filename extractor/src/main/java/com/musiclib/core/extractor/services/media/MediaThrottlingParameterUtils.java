 ...
 */
final class MediaThrottlingParameterUtils {
    ...
    private MediaThrottlingParameterUtils() {
    }

    /**
     * Get the throttling parameter deobfuscation function name of Media's base JavaScript file.
     *
    ...
    /**
     * Get the throttling parameter deobfuscation code of Media's base JavaScript file.
     *
     * @param javaScriptPlayerCode the complete JavaScript base player code
