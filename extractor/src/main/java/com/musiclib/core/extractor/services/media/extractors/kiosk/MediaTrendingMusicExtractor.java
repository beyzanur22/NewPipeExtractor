...
public class MediaTrendingMusicExtractor extends MediaChartsBaseKioskExtractor {

    public MediaTrendingMusicExtractor(final StreamingService streamingService,
    ...
    public String getName() throws ParsingException {
        // This is the official Media Charts name, even if autogenerated tracks and unofficial
