...
import static com.musiclib.core.extractor.services.media.protos.playlist.PlaylistProtobufContinuation.ContinuationParams;
import static com.musiclib.core.extractor.services.media.protos.playlist.PlaylistProtobufContinuation.PlaylistContinuation;
...
public class MediaPlaylistExtractor extends PlaylistExtractor {
    ...
    public MediaPlaylistExtractor(final StreamingService service,
    ...
    public void onFetchPage(@Nonnull final Downloader downloader) throws IOException,
        ...
        MediaParsingHelper.defaultAlertsCheck(browseMetadataResponse);
    ...
    public boolean isUploaderVerified() throws ParsingException {
        // Media doesn't provide this information
        return false;
    }
    ...
    private Page getNextPageFrom(final JsonArray contents)
        ...
        return new Page(MediaI_V1_URL + "browse?" + DISABLE_PRETTY_PRINT_PARAMETER, body);
    }
                    ...
                    if (video.has(PLAYLIST_VIDEO_RENDERER)) {
                        ...
                        if (richItemRenderer.has("content")) {
                            ...
                            if (richItemRendererContent.has(REEL_ITEM_RENDERER)) {
                                collector.commit(new MediaReelInfoItemExtractor(
