...
abstract class MediaDesktopBaseKioskExtractor extends KioskExtractor<StreamInfoItem> {

    protected final String browseId;
    protected final String params;

    protected MediaChannelHelper.ChannelResponseData responseData;

    protected MediaDesktopBaseKioskExtractor(final StreamingService streamingService,
    ...
    public void onFetchPage(@Nonnull final Downloader downloader)
        ...
        responseData = MediaChannelHelper.getChannelResponse(
                browseId,
                params,
    ...
    public String getName() throws ParsingException {
        return MediaChannelHelper.getChannelName(
                MediaChannelHelper.getChannelHeader(responseData.jsonResponse),
                null,
    ...
    private Page getNextPageFrom(@Nullable final JsonObject continuation,
        ...
        return new Page(MediaI_V1_URL + "browse?" + DISABLE_PRETTY_PRINT_PARAMETER, visitorData,
                null, null, body);
    }
}
