...
/**
 * Extractor of Media lockup view models for stream items.
 *
 ...
 *     <li>Media Premium Paid content</li>
 * </ul>
 */
public class MediaStreamInfoItemLockupExtractor implements StreamInfoItemExtractor {
    ...
    /**
     * Creates an extractor of StreamInfoItems from a Media page.
     *
     * @param lockupViewModel The JSON page element
     * @param timeAgoParser A parser of the textual dates or {@code null}.
     */
    public MediaStreamInfoItemLockupExtractor(@Nonnull final JsonObject lockupViewModel,
    ...
    public long getDuration() throws ParsingException {
        ...
        for (final String potentialDuration : potentialDurations) {
            ...
            try {
                return MediaParsingHelper.parseDurationString(potentialDuration);
    ...
    private String resolveUploaderUrlFromRelativeUrl(@Nonnull final String relativeUrl)
        ...
        return MediaChannelLinkHandlerFactory.getInstance().getUrl(
    ...
    public List<Image> getUploaderAvatars() throws ParsingException {
        return MediaParsingHelper.getImagesFromThumbnailsArray(
            JsonUtils.getArray(
    ...
    public boolean isUploaderVerified() throws ParsingException {
        ...
        return MediaParsingHelper.hasArtistOrVerifiedIconBadgeAttachment(metadataRows.get(0)
                .getObject(0)
                .getObject("text")
    ...
    public long getViewCount() throws ParsingException {
        ...
        /*
         * Media uses 2 rows for stream items outside channels and course playlists: one for
    ...
    private String getDateText() throws ParsingException {
        if (cachedDateText == null) {
            ...
            /*
             * Media uses 2 rows for stream items outside channels and course playlists: author(s)
