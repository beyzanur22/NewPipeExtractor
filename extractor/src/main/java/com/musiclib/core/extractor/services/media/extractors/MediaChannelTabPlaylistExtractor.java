...
/**
 * A {@link ChannelTabExtractor} for Media system playlists using a
 * {@link MediaPlaylistExtractor} instance.
 *
 * <p>
 ...
 * </p>
 */
public class MediaChannelTabPlaylistExtractor extends ChannelTabExtractor {

    private final PlaylistExtractor playlistExtractorInstance;
    private boolean playlistExisting;

    /**
     * Construct a {@link MediaChannelTabPlaylistExtractor} instance.
     *
     * @param service     a {@link StreamingService} implementation, which must be the Media
     *                    one
     ...
     */
    public MediaChannelTabPlaylistExtractor(@Nonnull final StreamingService service,
        ...
        this.playlistExtractorInstance = new MediaPlaylistExtractor(service, playlistLinkHandler);
    }
     ...
     *
     * <p>
     * This method converts a channel ID without its {@code UC} prefix into a Media system
     ...
     * {@link MediaChannelTabPlaylistExtractor} instance is being constructed
     *
     * @return a {@link ListLinkHandler} to use for the {@link MediaPlaylistExtractor} instance
    ...
    private ListLinkHandler getPlaylistLinkHandler(
        ...
        try {
            final String newUrl = MediaPlaylistLinkHandlerFactory.getInstance()
                    .getUrl(playlistId);
            ...
            // MediaPlaylistLinkHandlerFactory doesn't throw any exception
    ...
    /**
     * Exception thrown when a Media system playlist URL could not be created.
     *
     * <p>
