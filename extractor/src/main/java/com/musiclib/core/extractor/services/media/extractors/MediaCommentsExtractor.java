...
public class MediaCommentsExtractor extends CommentsExtractor {
    ...
    private void collectCommentItem(@Nonnull final JsonArray mutations,
        ...
        if (content.has("commentThreadRenderer")) {
            ...
            if (commentThreadRenderer.has(COMMENT_VIEW_MODEL_KEY)) {
                ...
                collector.commit(new MediaCommentsEUVMInfoItemExtractor(
                        commentViewModel,
                ...
                collector.commit(new MediaCommentsInfoItemExtractor(
            ...
            // Also, Media has only one comment reply level
            collector.commit(new MediaCommentsInfoItemExtractor(
