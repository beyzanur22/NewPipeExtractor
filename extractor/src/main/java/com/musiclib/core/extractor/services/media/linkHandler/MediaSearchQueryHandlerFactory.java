...
public final class MediaSearchQueryHandlerFactory extends SearchQueryHandlerFactory {

    private static final MediaSearchQueryHandlerFactory INSTANCE =
            new MediaSearchQueryHandlerFactory();
...
// = "https://www.Media.com/results?search_query="
...
// = "https://music.Media.com/search?q="

    @Nonnull
    public static MediaSearchQueryHandlerFactory getInstance() {
        return INSTANCE;
    }
