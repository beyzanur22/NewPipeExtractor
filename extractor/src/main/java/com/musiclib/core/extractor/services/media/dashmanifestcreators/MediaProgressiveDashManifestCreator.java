...
/**
 * Class which generates DASH manifests of {@link DeliveryType#PROGRESSIVE Media progressive}
 * streams.
 */
public final class MediaProgressiveDashManifestCreator {
    ...
    private MediaProgressiveDashManifestCreator() {
    }

    /**
     * Create DASH manifests from a Media progressive stream.
     *
     * <p>
     * Progressive streams are Media DASH streams which work with range requests and without the
     * need to get a manifest.
     * </p>
     *
     * <p>
     * They can be found on all videos, and for all streams for most of videos which come from a
     * Media partner, and on videos with a large number of views.
     * </p>
     *
     * This method needs:
     * <ul>
     ...
     * {@link MediaDashManifestCreatorsUtils#generateRepresentationElement(Document, ItagItem)}).
     * </p>
     *
