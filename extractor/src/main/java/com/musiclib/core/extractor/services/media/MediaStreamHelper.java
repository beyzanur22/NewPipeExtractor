...
import static com.musiclib.core.extractor.services.media.MediaParsingHelper.MediaI_V1_GAPIS_URL;
import static com.musiclib.core.extractor.services.media.MediaParsingHelper.MediaI_V1_URL;
import static com.musiclib.core.extractor.services.media.MediaParsingHelper.generateTParameter;
...
import static com.musiclib.core.extractor.services.media.MediaParsingHelper.getClientVersion;
...
import static com.musiclib.core.extractor.services.media.MediaParsingHelper.getVisionOsUserAgent;
...
// = "https://www.Media.com/watch?v="
    ...
    public static JsonObject getWebMetadataPlayerResponse(
        ...
        final Map<String, List<String>> headers = getMediaHeaders();
        ...
        innertubeClientRequestInfo.clientInfo.visitorData =
                MediaParsingHelper.getVisitorDataFromInnertube(innertubeClientRequestInfo,
                        localization, contentCountry, headers, MediaI_V1_URL, null, false);
        ...
        final String url = MediaI_V1_URL + PLAYER + "?" + DISABLE_PRETTY_PRINT_PARAMETER
...
// = "https://www.Media.com"
        ...
        innertubeClientRequestInfo.clientInfo.visitorData = webEmbeddedPoTokenResult == null
                ? MediaParsingHelper.getVisitorDataFromInnertube(innertubeClientRequestInfo,
                        localization, contentCountry, headers, MediaI_V1_URL, embedUrl, false)
    ...
    public static JsonObject getAndroidPlayerResponse(
        ...
        final String url = MediaI_V1_GAPIS_URL + PLAYER + "?" + DISABLE_PRETTY_PRINT_PARAMETER
    ...
    public static JsonObject getAndroidReelPlayerResponse(
        ...
        innertubeClientRequestInfo.clientInfo.visitorData =
                MediaParsingHelper.getVisitorDataFromInnertube(innertubeClientRequestInfo,
                        localization, contentCountry, headers, MediaI_V1_GAPIS_URL, null, false);
        ...
        final String url = MediaI_V1_GAPIS_URL + "reel/reel_item_watch" + "?"
