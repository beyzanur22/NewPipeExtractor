...
public class MediaMusicArtistInfoItemExtractor implements ChannelInfoItemExtractor {
    private final JsonObject artistInfoItem;

    public MediaMusicArtistInfoItemExtractor(final JsonObject artistInfoItem) {
    ...
    public long getSubscriberCount() throws ParsingException {
        ...
        final JsonArray runs = flexColumns
                ...
                .getObject("text")
                .getArray("runs");
        // NOTE: MediaParsingHelper#getTextFromObject would use all entries from the run array,
    ...
    public boolean isVerified() {
        // An artist on Media Music is always verified
        return true;
    }
