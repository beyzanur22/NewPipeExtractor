...
public class MediaMusicSongOrVideoInfoItemExtractor implements StreamInfoItemExtractor {
    private final JsonObject songOrVideoInfoItem;
    private final JsonArray descriptionElements;
    private final String searchType;

    public MediaMusicSongOrVideoInfoItemExtractor(final JsonObject songOrVideoInfoItem,
    ...
    public boolean isUploaderVerified() {
        // We don't have the ability to know this information on Media Music
        return false;
    }
