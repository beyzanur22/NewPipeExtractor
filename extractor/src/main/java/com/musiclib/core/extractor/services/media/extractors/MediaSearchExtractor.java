...
import static com.musiclib.core.extractor.services.media.linkHandler.MediaSearchQueryHandlerFactory.ALL;
...
import static com.musiclib.core.extractor.services.media.linkHandler.MediaSearchQueryHandlerFactory.getSearchParameter;
 ...
 * MediaSearchExtractor.java is part of NewPipe Extractor.
 *
...
public class MediaSearchExtractor extends SearchExtractor {
    ...
    public MediaSearchExtractor(final StreamingService service,
        ...
        // requested search type, as Media returns sometimes videos inside channel search results
    ...
    public List<MetaInfo> getMetaInfo() throws ParsingException {
        return MediaMetaInfoHelper.getMetaInfo(
        ...
        for (final Object content : contents) {
            ...
            if (item.has("backgroundPromoRenderer")) {
                ...
                if (("LOCKUP_CONTENT_TYPE_PLAYLIST".equals(contentType)
                    ...
                    collector.commit(
                            new MediaMixOrPlaylistLockupInfoItemExtractor(lockupViewModel));
                } else if ("LOCKUP_CONTENT_TYPE_VIDEO".equals(contentType)
                        && extractVideoResults) {
                    collector.commit(new MediaStreamInfoItemLockupExtractor(
    ...
    private Page getNextPageFrom(final JsonObject continuationItemRenderer) {
        ...
        final String url = MediaI_V1_URL + "search?" + DISABLE_PRETTY_PRINT_PARAMETER;
