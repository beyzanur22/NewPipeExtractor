...
public class MediaMusicPremiumContentException extends ContentNotAvailableException {
    ...
    public MediaMusicPremiumContentException() {
        super(StringObfuscator.decode(MSG));
    }

    public MediaMusicPremiumContentException(final Throwable cause) {
