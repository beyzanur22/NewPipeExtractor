...
/**
 * Streaming format types used by Media in their streams.
 *
 * <p>
 * It is different from {@link com.musiclib.core.extractor.stream.DeliveryMethod delivery methods}!
 * </p>
 */
public enum DeliveryType {

    /**
     * Media's progressive delivery method, which works with HTTP range headers.
    ...
    /**
     * Media's OTF delivery method which uses a sequence parameter to get segments of
     * streams.
     *
     * <p>
    ...
    /**
     * Media's delivery method for livestreams which uses a sequence parameter to get
     * segments of streams.
     *
     * <p>
