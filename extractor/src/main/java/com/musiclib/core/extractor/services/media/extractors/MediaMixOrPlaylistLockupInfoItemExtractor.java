...
public class MediaMixOrPlaylistLockupInfoItemExtractor implements PlaylistInfoItemExtractor {
    ...
    public MediaMixOrPlaylistLockupInfoItemExtractor(@Nonnull final JsonObject lockupViewModel) {
    ...
    public String getUrl() throws ParsingException {
        ...
        if (playlistType == PlaylistInfo.PlaylistType.NORMAL) {
            try {
                return MediaPlaylistLinkHandlerFactory.getInstance().getUrl(getPlaylistId());
