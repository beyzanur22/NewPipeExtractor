...
public final class MediaTrendingGamingVideosLinkHandlerFactory extends ListLinkHandlerFactory {

    public static final String KIOSK_ID = "trending_gaming";

    public static final MediaTrendingGamingVideosLinkHandlerFactory INSTANCE =
            new MediaTrendingGamingVideosLinkHandlerFactory();

    private MediaTrendingGamingVideosLinkHandlerFactory() {
    }
...
// = "https://www.Media.com/gaming/trending"
    }
