...
public final class MediaTrendingMoviesAndShowsTrailersLinkHandlerFactory
        extends ListLinkHandlerFactory {

    public static final String KIOSK_ID = "trending_movies_and_shows";

    public static final MediaTrendingMoviesAndShowsTrailersLinkHandlerFactory INSTANCE =
            new MediaTrendingMoviesAndShowsTrailersLinkHandlerFactory();

    private static final String PATH = "/charts/TrendingTrailers";

    private MediaTrendingMoviesAndShowsTrailersLinkHandlerFactory() {
    }
