...
import static com.musiclib.core.extractor.services.media.dashmanifestcreators.MediaDashManifestCreatorsUtils.ALR_YES;
import static com.musiclib.core.extractor.services.media.dashmanifestcreators.MediaDashManifestCreatorsUtils.RN_0;
...
import static com.musiclib.core.extractor.services.media.dashmanifestcreators.MediaDashManifestCreatorsUtils.SQ_0;
import static com.musiclib.core.extractor.services.media.dashmanifestcreators.MediaDashManifestCreatorsUtils.buildAndCacheResult;
import static com.musiclib.core.extractor.services.media.dashmanifestcreators.MediaDashManifestCreatorsUtils.generateDocumentAndDoCommonElementsGeneration;
import static com.musiclib.core.extractor.services.media.dashmanifestcreators.MediaDashManifestCreatorsUtils.generateSegmentTemplateElement;
import static com.musiclib.core.extractor.services.media.dashmanifestcreators.MediaDashManifestCreatorsUtils.generateSegmentTimelineElement;
import static com.musiclib.core.extractor.services.media.dashmanifestcreators.MediaDashManifestCreatorsUtils.getInitializationResponse;
import static com.musiclib.core.extractor.services.media.dashmanifestcreators.MediaDashManifestCreatorsUtils.setAttribute;
...
import com.musiclib.core.extractor.utils.ManifestCreatorCache;
...
/**
 * Class which generates DASH manifests of Media post-live DVR streams (which use the
 * {@link DeliveryType#LIVE LIVE delivery type}).
 */
public final class MediaPostLiveStreamDvrDashManifestCreator {
    ...
    private MediaPostLiveStreamDvrDashManifestCreator() {
    }

    /**
     * Create DASH manifests from a Media post-live-DVR stream/ended livestream.
     *
     * <p>
     * Post-live-DVR streams/ended livestreams are one of the Media DASH specific streams which
     ...
     *     sequence parameter is appended (see {@link MediaDashManifestCreatorsUtils#SQ_0}))
     ...
     *                                      field for each stream in Media's player response)
     ...
     *                              be appended
     * @param targetDurationSeconds the {@code targetDurationSec} value from Media player
     *                              response's stream
