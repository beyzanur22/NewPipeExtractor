 ...
 * MediaSuggestionExtractor.java is part of NewPipe Extractor.
 *
...
public class MediaSuggestionExtractor extends SuggestionExtractor {

    public MediaSuggestionExtractor(final StreamingService service) {
        super(service);
    }
