...
import static com.musiclib.core.extractor.MediaFormat.M4A;
import static com.musiclib.core.extractor.MediaFormat.MPEG_4;
import static com.musiclib.core.extractor.MediaFormat.WEBM;
import static com.musiclib.core.extractor.MediaFormat.WEBMA;
import static com.musiclib.core.extractor.MediaFormat.WEBMA_OPUS;
import static com.musiclib.core.extractor.MediaFormat.v3GPP;
import static com.musiclib.core.extractor.services.media.ItagItem.ItagType.AUDIO;
import static com.musiclib.core.extractor.services.media.ItagItem.ItagType.VIDEO;
import static com.musiclib.core.extractor.services.media.ItagItem.ItagType.VIDEO_ONLY;

public class ItagItem implements Serializable {

    /**
     * List can be found here:
     * https://github.com/ytdl-org/Media-dl/blob/e988fa4/Media_dl/extractor/Media.py#L1195
     */
     ...
     *
     * <p>
     * It is set to the {@code fps} value returned in the corresponding itag in the Media player
     * response.
     * </p>
     *
     * <p>
     ...
     * ended livestreams. It is only returned by Media for these stream types, and makes no sense
     ...
     *
     * <p>
     * It is only returned for these stream types by Media and makes no sense for videos, so
