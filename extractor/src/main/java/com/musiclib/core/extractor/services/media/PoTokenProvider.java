...
/**
 * Interface to provide {@code poToken}s to Media player requests.
 *
 * <p>
 * On some major clients, Media requires that the integrity of the device passes some checks to
 * allow playback.
 * </p>
 *
 * <p>
...
public interface PoTokenProvider {
     ...
     *
     * <p>
     * Note that Media desktop website generates two {@code poToken}s:
     ...
     *
     * <p>
     * As of writing, like the Media desktop website previously did, it generates only one
     ...
     * non-rooted Media patched with reVanced doesn't work without spoofing another InnerTube
