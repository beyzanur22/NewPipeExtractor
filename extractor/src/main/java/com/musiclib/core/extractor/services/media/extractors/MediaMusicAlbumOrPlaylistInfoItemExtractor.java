...
public class MediaMusicAlbumOrPlaylistInfoItemExtractor implements PlaylistInfoItemExtractor {
    private final JsonObject albumOrPlaylistInfoItem;
    private final JsonObject descriptionElementUploader;

    public MediaMusicAlbumOrPlaylistInfoItemExtractor(final JsonObject albumOrPlaylistInfoItem,
    ...
    public long getStreamCount() throws ParsingException {
        // Media Music album and playlist info items don't expose the stream count anywhere...
