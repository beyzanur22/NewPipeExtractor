 ...
 * MediaTrendingExtractor.java is part of NewPipe Extractor.
 *
...
import static com.musiclib.core.extractor.services.media.MediaParsingHelper.getTextAtKey;
...
public class MediaTrendingExtractor extends KioskExtractor<StreamInfoItem> {
    ...
    public MediaTrendingExtractor(final StreamingService service,
        ...
        if (tabContent.has("richGridRenderer")) {
            tabContent.getObject("richGridRenderer")
                    ...
                    .forEachOrdered(videoRenderer -> collector.commit(
                            new MediaStreamInfoItemExtractor(videoRenderer, timeAgoParser)));
