...
import com.musiclib.core.extractor.utils.jsextractor.JavaScriptExtractor;
...
/**
 * Utility class to get the signature timestamp of Media's base JavaScript player and deobfuscate
 * signature of streaming URLs from HTML5 clients.
 */
final class MediaSignatureUtils {
    ...
    private MediaSignatureUtils() {
    }

    /**
     * Get the signature timestamp property of Media's base JavaScript file.
     *
    ...
    /**
     * Get the signature deobfuscation code of Media's base JavaScript file.
     *
     * @param javaScriptPlayerCode the complete JavaScript base player code
