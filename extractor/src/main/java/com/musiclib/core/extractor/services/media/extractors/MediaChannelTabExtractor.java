...
import com.musiclib.core.extractor.services.media.MediaChannelHelper;
...
import static com.musiclib.core.extractor.services.media.MediaChannelHelper.getChannelResponse;
import static com.musiclib.core.extractor.services.media.MediaChannelHelper.resolveChannelId;
...
/**
 * A {@link ChannelTabExtractor} implementation for the Media service.
 *
 * <p>
 ...
 * </p>
 */
public class MediaChannelTabExtractor extends ChannelTabExtractor {

    @Nullable
    protected MediaChannelHelper.ChannelHeader channelHeader;

    private JsonObject jsonResponse;
    private String channelId;

    public MediaChannelTabExtractor(final StreamingService service,
    ...
    public void onFetchPage(@Nonnull final Downloader downloader) throws IOException,
        ...
        final MediaChannelHelper.ChannelResponseData data = getChannelResponse(channelIdFromId,
                params, getExtractorLocalization(), getExtractorContentCountry());

        jsonResponse = data.jsonResponse;
        channelHeader = MediaChannelHelper.getChannelHeader(jsonResponse);
    ...
    public String getId() throws ParsingException {
       return MediaChannelHelper.getChannelId(channelHeader, jsonResponse, channelId);
    }

    protected String getChannelName() throws ParsingException {
        return MediaChannelHelper.getChannelName(channelHeader,
                MediaChannelHelper.getChannelAgeGateRenderer(jsonResponse),
                jsonResponse);
    }
    ...
    public InfoItemsPage<InfoItem> getInitialPage() throws IOException, ExtractionException {
        ...
        if (channelHeader == null) {
            ...
            verifiedStatus = MediaChannelHelper.isChannelVerified(channelHeader)
    ...
    Optional<JsonObject> getTabData() {
        final String urlSuffix = MediaChannelTabLinkHandlerFactory.getUrlSuffix(getName());
    ...
    private Optional<JsonObject> collectItem(@Nonnull final MultiInfoItemsCollector collector,
        ...
        if (item.has("richItemRenderer")) {
            ...
            collector.commit(new MediaGridShowRendererChannelInfoItemExtractor(
    ...
    private static void commitReel(@Nonnull final MultiInfoItemsCollector collector,
                                   ...
                                   @Nullable final String channelUrl) {
        collector.commit(
                new MediaReelInfoItemExtractor(reelItemRenderer) {
                    @Override
    ...
    private static void commitShortsLockup(@Nonnull final MultiInfoItemsCollector collector,
                                           ...
                                           @Nullable final String channelUrl) {
        collector.commit(
                new MediaShortsLockupInfoItemExtractor(shortsLockupViewModel) {
                    @Override
                    public String getUploaderName() throws ParsingException {
                        return isNullOrEmpty(channelName) ? super.getUploaderName() : channelName;
                    }
    ...
    private static void commitVideoLockup(@Nonnull final MultiInfoItemsCollector collector,
                                          ...
                                          @Nullable final String channelUrl) {
        collector.commit(
                new MediaStreamInfoItemLockupExtractor(lockupViewModel, timeAgoParser) {
                    @Override
    ...
    private void commitPlaylistLockup(@Nonnull final MultiInfoItemsCollector collector,
                                      ...
                                      @Nullable final String channelUrl) {
        collector.commit(
                new MediaMixOrPlaylistLockupInfoItemExtractor(playlistLockupViewModel) {
                    @Override
                    public String getUploaderName() throws ParsingException {
                        return isNullOrEmpty(channelName) ? super.getUploaderName() : channelName;
                    }
    ...
    private void commitVideo(@Nonnull final MultiInfoItemsCollector collector,
                             ...
                             @Nullable final String channelUrl) {
        collector.commit(
                new MediaStreamInfoItemExtractor(jsonObject, timeAgoParser) {
                    @Override
                    public String getUploaderName() throws ParsingException {
                        return isNullOrEmpty(channelName) ? super.getUploaderName() : channelName;
                    }
    ...
    private void commitPlaylist(@Nonnull final MultiInfoItemsCollector collector,
                                ...
                                @Nullable final String channelUrl) {
        collector.commit(
                new MediaPlaylistInfoItemExtractor(jsonObject) {
                    @Override
                    public String getUploaderName() throws ParsingException {
                        return isNullOrEmpty(channelName) ? super.getUploaderName() : channelName;
                    }
    ...
    private Page getNextPageFrom(final JsonObject continuations,
        ...
        return new Page(MediaI_V1_URL + "browse?" + DISABLE_PRETTY_PRINT_PARAMETER, null,
                channelIds, null, body);
    }

    /**
     * A {@link MediaChannelTabExtractor} for the {@code Videos} tab, if it has been already
     * fetched.
     */
    public static final class VideosTabExtractor extends MediaChannelTabExtractor {
        ...
        VideosTabExtractor(final StreamingService service,
                           ...
                           @Nullable final MediaChannelHelper.ChannelHeader channelHeader,
                           final String channelName,
    ...
    private static final class MediaGridShowRendererChannelInfoItemExtractor
            extends MediaBaseShowInfoItemExtractor {
        ...
        private MediaGridShowRendererChannelInfoItemExtractor(
