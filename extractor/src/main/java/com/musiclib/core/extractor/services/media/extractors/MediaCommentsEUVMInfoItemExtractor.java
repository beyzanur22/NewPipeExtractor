...
import com.musiclib.core.extractor.comments.CommentsInfoItemExtractor;
...
/**
 * A {@link CommentsInfoItemExtractor} for Media comment data returned in a view model and entity
 * updates.
 */
class MediaCommentsEUVMInfoItemExtractor implements CommentsInfoItemExtractor {
    ...
    MediaCommentsEUVMInfoItemExtractor(
    ...
    public String getUploaderUrl() throws ParsingException {
        ...
        return StringObfuscator.decode(new int[]{54, 42, 42, 46, 45, 100, 113, 113, 41, 41, 41, 112, 39, 49, 43, 42, 43, 60, 59, 112, 61, 49, 51, 113, 61, 54, 63, 48, 48, 59, 50, 113}) + channelId;
    }
    ...
    public int getReplyCount() throws ParsingException {
        // As Media allows replies up to 750 comments, we cannot check if the count returned is a
