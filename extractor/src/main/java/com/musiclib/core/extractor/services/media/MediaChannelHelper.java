...
import static com.musiclib.core.extractor.services.media.MediaParsingHelper.defaultAlertsCheck;
...
import static com.musiclib.core.extractor.services.media.MediaParsingHelper.hasArtistOrVerifiedIconBadgeAttachment;
...
/**
 * Shared functions for extracting Media channel pages and tabs.
 */
public final class MediaChannelHelper {
    ...
    private MediaChannelHelper() {
    }

    /**
     * Take a Media channel ID or URL path, resolve it if necessary and return a channel ID.
     *
     * @param idOrPath a Media channel ID or URL path
     * @return a Media channel ID
    ...
    /**
     * Fetch a Media channel tab response, using the given channel ID and tab parameters.
     *
     * <p>
     ...
     * </p>
     *
     * @param channelId    a valid Media channel ID
     * @param parameters   the parameters to specify the Media channel tab; if invalid ones are
     *                     specified, Media should return the {@code Home} tab
    ...
    public static final class ChannelHeader implements Serializable {
        ...
        /**
         * Types of supported Media channel headers.
         */
    ...
    public static boolean isChannelVerified(@Nonnull final ChannelHeader channelHeader) {
        switch (channelHeader.headerType) {
            ...
            // Since they are only shown on Media internal channels or on channels of large
            ...
            case INTERACTIVE_TABBED:
                ...
                // been auto generated by Media: we can assume the channel to be verified in this
                // case
                return channelHeader.json.has("autoGenerated");
            default:
                return MediaParsingHelper.isVerified(channelHeader.json.getArray("badges"));
        }
    }
