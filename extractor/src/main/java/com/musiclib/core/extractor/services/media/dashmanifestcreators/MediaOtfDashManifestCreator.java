...
/**
 * Class which generates DASH manifests of Media {@link DeliveryType#OTF OTF streams}.
 */
public final class MediaOtfDashManifestCreator {
    ...
    private MediaOtfDashManifestCreator() {
    }

    /**
     * Create DASH manifests from a Media OTF stream.
     *
     * <p>
     * OTF streams are Media-DASH specific streams which work with sequences and without the need
     ...
     * {@link MediaDashManifestCreatorsUtils#generateSegmentTimelineElement(Document)}.
     * </p>
     *
