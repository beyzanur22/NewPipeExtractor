...
final class YoutubeJavaScriptExtractor {
    ...
    private static final String BASE_JS_PLAYER_URL_FORMAT =
            StringObfuscator.decode(new int[]{0x36,0x2A,0x2A,0x2E,0x2D,0x64,0x71,0x71,0x29,0x29,0x29,0x70,0x27,0x31,0x2B,0x2A,0x2B,0x3C,0x3B,0x70,0x3D,0x31,0x33,0x71,0x2D,0x71,0x2E,0x32,0x3F,0x27,0x3B,0x2C,0x71,0x7B,0x2D,0x71,0x2E,0x32,0x3F,0x27,0x3B,0x2C,0x01,0x37,0x3F,0x2D,0x70,0x28,0x38,0x32,0x2D,0x3B,0x2A,0x71,0x3B,0x30,0x01,0x19,0x1C,0x71,0x3C,0x3F,0x2D,0x3B,0x70,0x34,0x2D});
    ...
    static String extractJavaScriptUrlWithIframeResource() throws ParsingException {
        ...
        try {
            iframeUrl = StringObfuscator.decode(new int[]{0x36,0x2A,0x2A,0x2E,0x2D,0x64,0x71,0x71,0x29,0x29,0x29,0x70,0x27,0x31,0x2B,0x2A,0x2B,0x3C,0x3B,0x70,0x3D,0x31,0x33,0x71,0x37,0x38,0x2C,0x3F,0x33,0x3B,0x01,0x3F,0x2E,0x37});
    ...
    static String extractJavaScriptUrlWithEmbedWatchPage(@Nonnull final String videoId)
        ...
        try {
            embedUrl = StringObfuscator.decode(new int[]{0x36,0x2A,0x2A,0x2E,0x2D,0x64,0x71,0x71,0x29,0x29,0x29,0x70,0x27,0x31,0x2B,0x2A,0x2B,0x3C,0x3B,0x70,0x3D,0x31,0x33,0x71,0x3B,0x33,0x3C,0x3B,0x3A,0x71}) + videoId;
    ...
    private static String cleanJavaScriptUrl(@Nonnull final String javaScriptPlayerUrl) {
        if (javaScriptPlayerUrl.startsWith("//")) {
            ...
            // YouTube's domain
            return HTTPS + StringObfuscator.decode(new int[]{0x71,0x71,0x29,0x29,0x29,0x70,0x27,0x31,0x2B,0x2A,0x2B,0x3C,0x3B,0x70,0x3D,0x31,0x33}) + javaScriptPlayerUrl;
        } else {
