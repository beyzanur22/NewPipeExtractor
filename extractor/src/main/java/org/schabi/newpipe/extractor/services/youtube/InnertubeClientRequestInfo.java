    ...
    public static InnertubeClientRequestInfo ofAndroidVRClient() {
        return new InnertubeClientRequestInfo(
                new InnertubeClientRequestInfo.ClientInfo(ANDROID_VR_CLIENT_NAME,
                        ANDROID_VR_CLIENT_VERSION, ANDROID_VR_CLIENT_ID, WATCH_CLIENT_SCREEN, null),
                new InnertubeClientRequestInfo.DeviceInfo(MOBILE_CLIENT_PLATFORM, null,
                        ANDROID_VR_DEVICE_MODEL, "Android", "16", 36));
    }
}
