    ...
    public String getId(final String url) throws ParsingException, UnsupportedOperationException {
        try {
            ...
            if (!Utils.isHTTP(urlObj) || !(YoutubeParsingHelper.isYoutubeURL(urlObj)
                ...
                throw new ParsingException(StringObfuscator.decode(new int[]{0x2A,0x36,0x3B,0x7E,0x2B,0x2C,0x32,0x7E,0x39,0x37,0x28,0x3B,0x30,0x7E,0x37,0x2D,0x7E,0x30,0x31,0x2A,0x7E,0x3F,0x7E,0x07,0x31,0x2B,0x0A,0x2B,0x3C,0x3B,0x73,0x0B,0x0C,0x12}));
            }
