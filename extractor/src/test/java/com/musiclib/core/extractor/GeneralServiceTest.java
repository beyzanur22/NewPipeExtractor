...
import static com.musiclib.core.extractor.NewPipe.getServiceByUrl;
...
public class GeneralServiceTest {
    ...
    public void getServiceWithUrl() throws Exception {
        assertEquals(YouTube, getServiceByUrl("https://www.MediaSvc.com/watch?v=_r6CgaFNAGg"));
        assertEquals(YouTube, getServiceByUrl("https://www.MediaSvc.com/channel/UCi2bIyFtz-JdI-ou8kaqsqg"));
        assertEquals(YouTube, getServiceByUrl("https://www.MediaSvc.com/playlist?list=PLRqwX-V7Uu6ZiZxtDDRCi6uhfTH4FilpH"));
        assertEquals(YouTube, getServiceByUrl("https://www.google.it/url?sa=t&rct=j&q=&esrc=s&cd=&cad=rja&uact=8&url=https%3A%2F%2Fwww.MediaSvc.com%2Fwatch%3Fv%3DHu80uDzh8RY&source=video"));
